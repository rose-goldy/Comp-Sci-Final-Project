...
class Functions: ObservableObject {
    @Published var pivotGOE: String = ""
    @Published var noHoldGOE: String = ""
    @Published var triangleGOE: String = ""
    @Published var twizzlesGOE: String = ""
    @Published var movesGOE: String = ""
    @Published var finalPivotValue: String = ""
    @Published var finalNoHoldValue: String = ""
    @Published var finalTriangleValue: String = ""
    @Published var finalTwizzlesValue: String = ""
    @Published var finalMovesValue: String = ""
    @Published var pivotLevel: String = "Level"
    @Published var noHoldLevel: String = "Level"
    @Published var noHoldSteps: String = "Steps"
    @Published var triangleI: String = "I"
    @Published var trianglePI: String = "PI"
    @Published var twizzlesLevel: String = "Level"
    @Published var movesLevel: String = "Level"
    @Published var compScore: String = ""
    @Published var presScore: String = ""
    @Published var ssScore: String = ""
    @Published var finalComponentScore: String = ""
    @Published var finalTotalScore: String = ""
    @Published var techScore: Double = 0.0
    @Published var deductions: String = ""
    @Published var deductionScore: Double = 0.0
    @Published var firstElement: String = "Element 1"
    @Published var secondElement: String = "Element 2"
    @Published var thirdElement: String = "Element 3"
    @Published var fourthElement: String = "Element 4"
    @Published var fifthElement: String = "Element 5"
